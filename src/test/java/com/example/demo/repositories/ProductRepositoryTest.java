...
public class ProductRepositoryTest {
    ...
    public void testSaveProduct() {
        ...
        assertThat(savedProduct.getPprice()).isEqualTo(10.99);
        assertThat(savedProduct.getPdescription()).isEqualTo("Test Description");
    }
    ...
    public void testFindProductById() {
        ...
        assertThat(foundProduct.getPprice()).isEqualTo(10.99);
        assertThat(foundProduct.getPdescription()).isEqualTo("Test Description");
    }
    ...
    public void testUpdateProduct() {
        ...
        persistedProduct.setPprice(15.99);
        ...
        assertThat(updatedProduct.getPprice()).isEqualTo(15.99);
        assertThat(updatedProduct.getPdescription()).isEqualTo("Test Description");
    }
