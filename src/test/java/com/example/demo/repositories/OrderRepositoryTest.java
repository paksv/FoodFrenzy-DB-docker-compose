...
public class OrderRepositoryTest {
    ...
    public void testSaveOrder() {
        ...
        order.setoPrice(99.99);
        order.setoQuantity(2);
        order.setOrderDate(new Date());
        order.setTotalAmmout(199.98);
        ...
        assertThat(savedOrder.getoPrice()).isEqualTo(99.99);
        assertThat(savedOrder.getoQuantity()).isEqualTo(2);
        assertThat(savedOrder.getTotalAmmout()).isEqualTo(199.98);
    ...
    public void testFindOrderById() {
        ...
        assertThat(foundOrder.getoPrice()).isEqualTo(99.99);
    ...
    public void testFindOrdersByUser() {
        ...
        assertThat(userOrders.get(0).getUser().getU_id()).isEqualTo(persistedUser.getU_id());
        assertThat(userOrders.get(1).getUser().getU_id()).isEqualTo(persistedUser.getU_id());
    }
    ...
    public void testUpdateOrder() {
        ...
        persistedOrder.setTotalAmmout(299.97);
        ...
        assertThat(updatedOrder.getTotalAmmout()).isEqualTo(299.97);
    }
